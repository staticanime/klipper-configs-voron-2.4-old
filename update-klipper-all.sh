...
make clean KCONFIG_CONFIG=klipper-mellow-fly-SB2040-v2.config
make menuconfig KCONFIG_CONFIG=klipper-mellow-fly-SB2040-v2.config
make -j 4 KCONFIG_CONFIG=klipper-mellow-fly-SB2040-v2.config
